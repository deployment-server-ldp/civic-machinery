...
export const countries: Country[] = [
  ...
  { code: "TR", name: "Turkey", flag: "🇹🇷", locale: "en" },
  { code: "IR", name: "Iran", flag: "🇮🇷", locale: "en" },
  { code: "BG", name: "Bulgaria", flag: "🇧🇬", locale: "en" },
  { code: "CN", name: "China", flag: "🇨🇳", locale: "en" },
  { code: "IN", name: "India", flag: "🇮🇳", locale: "en" },
  { code: "ID", name: "Indonesia", flag: "🇮🇩", locale: "en" },
  { code: "SG", name: "Singapore", flag: "🇸🇬", locale: "en" },
  { code: "VN", name: "Vietnam", flag: "🇻🇳", locale: "en" },
  { code: "ZW", name: "Zimbabwe", flag: "🇿🇼", locale: "en" },
  { code: "ZA", name: "South Africa", flag: "🇿🇦", locale: "en" },
