...
const za: Record<string, ProductContent> = {
  "hlp-180": {
    tagline: "Single-plunger hard pack line built for continuous running at 180 packs a minute.",
    h1: "HLP-180 Cigarette Packing Machine",
    metaTitle: "HLP-180 Cigarette Packing Machine, 180 Packs/Min",
    metaDescription: "HLP-180 cigarette packing machine exported from Pakistan to South Africa, 180 packs per minute across King to Nano formats with PLC control.",
    intro: [
      "Built for the pace of high-volume packing, the HLP-180 is a next-generation single-plunger machine that manufacturers in South Africa can rely on for consistent, repeatable output shift after shift.",
      "Running at 180 packs a minute, its single plunger mechanism holds alignment, wrapping and sealing steady through every cycle, so factories can meet demand without the finish drifting from pack to pack.",
      "The machine covers a wide format spread, King Size, Demi, Slims, Super Slims and Nano, letting one line serve several product segments rather than dedicating separate equipment to each.",
      "A PLC control system automates the process end to end, giving operators direct control over speed, error detection and production monitoring, which trims downtime and keeps output steady.",
      "Pack shape flexibility is where the HLP-180 stands out further: round corner, bevel edge, D-type and square formats are all supported, so brands can differentiate on shelf. Built for non-stop, large-scale production, it suits both a new line and an upgrade to older equipment.",
    ],
    applications: [
  ...
  "hlp-200": {
    tagline: "Double-plunger hopper packer built to hold cost and speed in balance at 200 packs a minute.",
    h1: "HLP-200 Cigarette Packing Machine",
    metaTitle: "HLP-200 Cigarette Packing Machine, 200 Packs/Min",
    metaDescription: "HLP-200 double plunger cigarette packing machine, 200 packs per minute, exported from Pakistan to South Africa across King to Nano formats.",
    intro: [
      "The HLP-200 is a double-plunger hopper packer sized for small-to-medium and high-volume production alike, valued for using material efficiently and keeping running costs down at a genuinely fast pace.",
      "At 200 packs a minute and a maximum throughput of around 12,000 cigarettes, it sits as the first critical unit on the packing line, forming and finishing the pack before wrapping and boxing take over, and it accepts all common pack formats without modification.",
      "Format range covers King Size, Demi, Slims, Super Slims and Nano, with the double plunger system keeping the cycle efficient and the finish consistent pack to pack. A PLC control system automates the run and gives operators clear oversight of speed, errors and monitoring.",
      "Pack presentation options include round corner, bevel edge, D-type and square formats. Running on a 220V/380V supply and built for continuous output, the HLP-200 makes a dependable core unit for an integrated packing line.",
    ],
    applications: [
      "High-volume hard pack production",
  ...
  "hlp-225": {
    tagline: "High-speed double-plunger packer pushing 225 packs a minute without losing finish quality.",
    h1: "HLP-225 Cigarette Packing Machine",
    metaTitle: "HLP-225 Cigarette Packing Machine, 225 Packs/Min",
    metaDescription: "HLP-225 high-speed cigarette packing machine, 225 packs per minute with PLC control, exported from Pakistan to South African manufacturers.",
    intro: [
      "The HLP-225 marks a real step up in packing capacity. This double-plunger machine runs at 225 packs a minute, giving factories scaling up production the throughput they need without sacrificing efficiency.",
      "Format coverage spans King, Demi, Slims, Super Slims and Nano, so a single machine can flex across the different products a manufacturer runs rather than requiring separate lines for each.",
      "A modern PLC control system automates the packing sequence and cuts manual intervention, reducing errors along the way. Multiple pack formats are supported too, round corner, bevel edge, D-type and square, letting brands tailor presentation to their market.",
      "Built for large-scale production, the HLP-225 combines its advanced control features with a robust build for consistent, reliable performance, a genuine asset for any operation looking to scale output while staying competitive.",
    ],
    applications: [
      "High-volume hard pack production",
  ...
  "sasib-5000": {
    tagline: "SASIB arbour-wrapped soft packer turning out squared-corner 100mm packs.",
    h1: "SASIB 5000 Soft Pack Machine",
    metaTitle: "SASIB 5000 Soft Pack Cigarette Machine",
    metaDescription: "SASIB 5000 soft pack cigarette machine, 100mm packs with alufoil and label wrapping, exported from Pakistan to South Africa.",
    intro: [
      "The SASIB 5000 is built specifically for 100mm soft pack cigarettes, wrapping each pack in alufoil and label around an arbour to produce a clean, consistently squared corner finish.",
      "That arbour-wrapping method is functional as well as attractive, it protects the cigarettes and holds the pack intact while lifting the visual finish of the product on shelf, which matters for manufacturers targeting a premium soft pack look.",
      "Well proven in the field and straightforward to operate, the SASIB 5000 is supplied checked, set up and ready to run, so soft pack capacity can be added with confidence.",
    ],
    applications: [
  ...
  "sasib-3000": {
    tagline: "SASIB arbour-wrapped soft packer handling both 84mm and 100mm formats.",
    h1: "SASIB 3000 Soft Pack Machine",
    metaTitle: "SASIB 3000 Soft Pack Cigarette Machine",
    metaDescription: "SASIB 3000 soft pack cigarette machine, 84mm and 100mm formats with alufoil and label wrapping, exported from Pakistan to South Africa.",
    intro: [
      "The SASIB 3000 extends the SASIB soft pack range with dual-format capability, handling both 84mm and 100mm cigarette packs while keeping the same arbour-wrapped finish, squared corners, clean and consistent, across both sizes.",
      "That dual-size ability gives manufacturers real flexibility in production planning without compromising on presentation or protection, an asset for factories running more than one pack length.",
      "Adjustments and maintenance are straightforward through its control systems, which helps hold downtime down and productivity up. Supplied checked and set up ready to run, it is a dependable soft pack line for factories wanting both quality and format flexibility.",
    ],
    applications: [
      "Soft pack production",
  ...
  "regular-wrapper-cp1": {
    tagline: "CP-1 pack overwrapper built for high-throughput lines at up to 250 packs a minute.",
    h1: "Regular Wrapper CP1",
    metaTitle: "CP-1 Cigarette Pack Wrapping Machine, 250 PPM",
    metaDescription: "CP-1 cigarette pack wrapping machine, up to 250 packs per minute, exported from Pakistan to South Africa by Civic Tobacco Machinery.",
    intro: [
      "The CP-1 is a high-performance overwrapper engineered for serious production demands, lifting the throughput of the packing line at a wrapping speed of up to 250 packs a minute.",
      "Power draw is a modest 6 KVA with an air pressure requirement of 0.05 m³/min, so strong output comes without a heavy energy footprint. Precision wrapping cuts material waste and keeps every pack to a tight, consistent standard.",
      "Its robust construction keeps the process smooth on high-volume lines, and it integrates cleanly into an existing setup, a practical addition for any facility looking to lift productivity without giving up on quality.",
    ],
    applications: [
      "Pack overwrapping",
  ...
  "naked-over-wrapper": {
    tagline: "Outer pack overwrapper running a steady 25 outer packs a minute.",
    h1: "Naked Over Wrapper",
    metaTitle: "Naked Over Wrapper, Cigarette Outer Pack Wrapper",
    metaDescription: "Naked Over Wrapper cigarette outer pack machine, 25 outer packs per minute, exported from Pakistan to South Africa.",
    intro: [
      "The Naked Over Wrapper handles cigarette outer packs with precision and pace, wrapping 25 outer packs a minute to keep efficiency high at the end of the line.",
      "Power draw sits at 6 KVA with an air pressure need of 0.05 m³/min, giving dependable performance without a heavy energy draw. Robust and efficient, it's a sound addition for lifting packaging quality at the final stage of production.",
    ],
    applications: [
  ...
  "molins-boxer": {
    tagline: "Molins Boxer forming cartons at up to 20 boxes a minute.",
    h1: "Molins Boxer, Box Packing Machine",
    metaTitle: "Molins Boxer, Cigarette Box Packing Machine",
    metaDescription: "Molins Boxer cigarette box packing machine, up to 20 boxes per minute, exported from Pakistan to South Africa by Civic Tobacco Machinery.",
    intro: [
      "The Molins Boxer is a dependable box packer known for efficient running and solid throughput, lifting productivity at a packing speed of up to 20 boxes a minute.",
      "Air pressure demand sits at 0.05 m³/min, balancing energy use against steady operation. Its engineering keeps packing consistent and precise, cutting downtime and holding product quality high.",
      "That reliability makes it a critical piece of any production setup focused on efficiency, taking wrapped packs from earlier in the line and forming them into tidy cartons at the end.",
    ],
    applications: [
      "Carton / box packing",
  ...
  "sasib-boxer": {
    tagline: "SASIB Boxer forming cartons at up to 25 boxes a minute.",
    h1: "SASIB Boxer, Box Packing Machine",
    metaTitle: "SASIB Boxer, Cigarette Box Packing Machine",
    metaDescription: "SASIB Boxer cigarette box packing machine, up to 25 boxes per minute, exported from Pakistan to South Africa by Civic Tobacco Machinery.",
    intro: [
      "The SASIB Boxer is an advanced box packer valued for its speed, giving a real lift to line throughput at up to 25 boxes a minute.",
      "It runs on 6 KVA of power and an air pressure need of 0.1 m³/min, striking a balance between energy use and operational output.",
      "Built for highly accurate, consistent packing, the SASIB Boxer keeps downtime down and the process streamlined, a valuable fit for high-volume environments where both speed and precision matter.",
    ],
    applications: [
      "Carton / box packing",
      "High-volume packing lines",
  ...
  "mark-8-post-64": {
    tagline: "The dependable Molins Mark 8 workhorse many factories still keep running.",
    ...
    metaDescription: "Molins Mark 8 Post 64 cigarette making machine, exported from Pakistan to South Africa, reconditioned and supported by Civic Tobacco Machinery.",
    intro: [
      "Proven over decades on production floors, the Molins Mark 8 Post 64 pairs quality with flexibility, holding a steady 1,800 to 2,000 cigarettes a minute while its double colour printer prints paper to your brand's exact specification without slowing the line.",
      "Format range runs from 17mm to 28.3mm cigarette circumference and 65mm to 110mm combined filter-and-tobacco rod length, covering standard 84mm and 100mm formats through to slims, super slims and nano, with a Max Multiroll filter attachment keeping filters feeding cleanly at full speed.",
      "At around 3,500kg it's a heavy, solid machine built to hold its pace through long runs, a combination of speed, format flexibility and reliability that makes it a sound pick for factories wanting strong output from a single maker.",
    ],
    features: [
  ...
  "mark-8d-max-15": {
    tagline: "Mark 8D with MAX-15 control, built to grow output without giving up quality.",
    h1: "Mark 8D MAX 15",
    metaTitle: "MK 8D | Molins Mark 8D with MAX-15 Cigarette Maker",
    metaDescription: "Molins Mark 8D with MAX-15 cigarette making machine, up to 3,000 per minute, exported from Pakistan to South African manufacturers.",
    intro: [
      "Part of the well-known Mark 8 maker family, the Molins Mark 8D with MAX-15 gives manufacturers a dependable route to more output without stepping down on quality, engineered for the pace of a modern tobacco factory.",
      "Running at up to 3,000 cigarettes a minute, it holds its pace comfortably on a busy line, and its format range, King size, Demi, Slims, Super Slims or Nano, means one machine can serve several segments rather than needing separate equipment for each.",
      "Circumference range runs 17mm to 28.3mm with combined filter and tobacco rod lengths of 65mm to 110mm, giving full control over sizing and consistency from one run to the next.",
      "The MK-8D cigarette maker pairs with the MAX-15 and its 1117 infeed unit, carrying the process cleanly from tobacco feeding to finished rod. That combination keeps the line steady, cuts stoppages and holds quality through the shift, at a total draw of 17KW that balances speed against running cost.",
      "Despite everything it does, the machine keeps a manageable footprint. At around 5,000kg it's solid and hard-wearing, yet drops into an existing floor without a major rebuild, and its build holds up to long, continuous production while turning out even cigarettes with little waste and modest upkeep.",
      "Altogether the Mark 8D with MAX-15 earns its place on proven reliability, format flexibility from slims to nano, accurate high-speed output, sensible energy use and easy fitment into an automated line, whether you're replacing older equipment or adding capacity.",
    ],
    applications: [
  ...
  "mark-9-5-lenze-servo-drives": {
    tagline: "Mark 9.5 line with Lenze servo precision, built for serious, sustained output.",
    h1: "Molins Mark 9.5 with Lenze Servo Drives",
    metaDescription: "Molins Mark 9.5 with Lenze servo drives, up to 3,500 cigarettes per minute, exported from Pakistan to South Africa with Siemens PLC control.",
    intro: [
      "Manufacturers wanting serious output without losing flexibility are the target for the Molins Mark 9.5 with Lenze servo drives, which turns out up to 3,500 cigarettes a minute on regular diameters and 3,200 a minute on slim and super slim formats, covering a broad product range from one line.",
      "Circumference range spans 17mm to 28.3mm with combined filter and tobacco rod lengths from 65mm to 110mm, giving room to switch formats while holding a consistent rod from run to run.",
      "Three units work together in this line, the MK-9.5 cigarette maker, the MAX-S filter assembler and the HCF80 automatic tray filler, drawing 35KW, 20KW and 15KW respectively, carrying the process from making through to filled trays with very little manual handling.",
      "Control and accuracy are central: a Siemens PLC runs the sequence, a microwave system holds tight control over rod weight, and the Lenze servo drives deliver the steady motion that keeps quality high even at full speed.",
      "At around 8,600kg total weight, it's a heavy, solid line built for large-scale manufacturing, a strong, future-ready choice for factories that need dependable high-volume output with modern controls and easy servicing.",
    ],
    applications: [
      "High-volume production",
      "Multi-format factories",
  ...
  "mark-9-5-max-s-tray-filler": {
    tagline: "Mark-9.5 with Max S, built for volume and tidy filter integration in one line.",
    h1: "Molins Mark-9.5 with Max S & Tray Filler",
    metaTitle: "Molins Mark-9.5 with Max S & Tray Filler",
    metaDescription: "Molins Mark-9.5 with Max S and tray filler, 4,500 to 5,000 cigarettes per minute, exported from Pakistan to South Africa.",
    intro: [
      "For manufacturers needing high-speed output, tidy filter integration and dependable capacity in a single line, the Molins Mark-9.5 with Max S and tray filler is engineered for volume, running a remarkable 4,500 to 5,000 cigarettes a minute, among the most efficient systems available for large-scale production.",
      "At its centre sits the MK-9.5 cigarette maker, an evolution of the proven Mark 9 series that holds strong output while keeping precision and consistency high. It supports circumferences of 17mm to 28.3mm and combined filter-and-tobacco rod lengths of 65mm to 110mm, moving between King size, Slims, Demi and other formats without losing rod quality.",
      "The maker pairs with the Max-S filter assembler, which attaches the filter to the tobacco rod accurately and repeatably. Working through a mass flow tray filler, it lifts throughput while keeping material waste and misalignment low, holding filter integrity consistent across every cycle.",
      "A default setup size of 84mm keeps the machine in step with globally accepted cigarette dimensions, a practical fit for both local supply and export production, moving smoothly between batches and adapting easily to changing orders.",
      "At roughly 7,800kg it's a heavy, stable line built for continuous operation and long service life, bringing together the speed, flexibility and reliability a growing floor needs, from proven making and precise filter attachment to a streamlined mass flow feed and a durable, heavy-duty frame.",
    ],
    applications: [
      "High-volume production",
  ...
  "mark-9-max-s": {
    tagline: "MK-9 with Max S, another high-efficiency maker built for serious production.",
    h1: "Molins MK-9 with Max S",
    metaTitle: "Molins MK-9 with Max S",
    metaDescription: "Molins MK-9 with Max S, 4,500 to 5,000 cigarettes per minute with mass flow tray filler, exported from Pakistan to South Africa.",
    intro: [
      "Running between 4,500 and 5,000 cigarettes a minute, the Molins MK-9 with Max S is a high-efficiency maker built for serious, steady output, a dependable choice for factories wanting strong production from a single line.",
      "The MK-9 cigarette maker at its core holds production precise and consistent shift after shift, working across circumferences of 17mm to 28.3mm and combined filter-and-tobacco rod lengths of 65mm to 110mm, giving real flexibility to move between formats without losing rod quality.",
      "Fitted with the Max-S filter assembler and a mass flow tray filler, it makes filter attachment faster and more reliable while keeping waste and misalignment low. A default setup size of 84mm keeps it in line with widely accepted cigarette dimensions, slotting into most production plans with ease.",
      "At around 7,800kg the MK-9 is a heavy, stable machine built for continuous running and long service life, a solid, reliable addition for a factory scaling up large-scale production while protecting quality.",
    ],
    applications: [
      "High-volume production",
      "Main maker line",
  ...
  "protos-70": {
    tagline: "Hauni Protos 70, built to meet the highest standards of speed and precision.",
    h1: "Protos 70",
    metaTitle: "Hauni Protos 70 Cigarette Making Machine",
    metaDescription: "Hauni Protos 70 cigarette making machine, up to 7,000 per minute, exported from Pakistan to South Africa with Siemens or Beckhoff IPC control.",
    intro: [
      "Engineered to meet the highest standards of production efficiency and precision, the Hauni Protos 70 runs an impressive 7,000 cigarettes a minute on regular diameters and 6,000 a minute on slim and super slim formats, giving real speed and flexibility from a single line.",
      "It handles circumferences from 17mm to 28.3mm with combined filter-and-tobacco rod lengths of 65mm to 110mm, moving across formats while holding a consistent rod from run to run.",
      "A Siemens IPC or Beckhoff IPC control system keeps the sequence automated and reliable, while a microwave weight control system holds every cigarette to a precise weight for steady consistency. The line combines the S7000 cigarette rod maker, the M8000 filter tip attachment and the F80 automatic tray filler, each handling its own stage of the process.",
      "With power draw of 50KW for the S7000, 20KW for the M8000 and 15KW for the F80, the Protos 70 is a powerful, capable line. At around 10,800kg total weight it's heavy and stable, built for continuous running and long service life, well suited to large-scale cigarette production.",
    ],
    applications: [
      "High-volume production",
  ...
  "protos-80-er": {
    tagline: "Protos 80 ER, Hauni's high-performance line for maximum efficiency and output.",
    h1: "Protos 80 ER",
    metaTitle: "Hauni Protos 80 ER Cigarette Making Machine",
    metaDescription: "Hauni Protos 80 ER cigarette making machine, up to 8,000 per minute, exported from Pakistan to South Africa with Siemens or Beckhoff IPC control.",
    intro: [
      "Built by Hauni for manufacturers chasing maximum efficiency, precision and output, the Protos 80 ER carries the series' reputation for reliability and advanced automation, delivering strong consistency whether you produce regular or slim cigarettes, a trusted pick for high-volume lines.",
      "Capacity is where it stands out: up to 8,000 cigarettes a minute on regular diameters and 7,000 on slim and super slim formats, with circumferences from 17mm to 28.3mm and combined filter-and-tobacco rod lengths of 65mm to 110mm, staying flexible from king size through slim to niche formats.",
      "A high-level PLC control system, on either Siemens IPC or Beckhoff IPC, keeps the whole cycle smooth and automated. Real-time monitoring and quick system response cut human error, and a built-in microwave weight control system holds consistent cigarette weight for tight quality control.",
      "Three powerful units work together: the S7000 cigarette rod maker at 50KW, the M8000 filter tip attachment at 20KW and the F80 automatic tray filler at 15KW. Used in cigarette factories worldwide, the Protos 80 combines efficient energy use, low wastage and precise engineering, at around 10,800kg total weight, a heavy, stable line built for continuous, large-scale production.",
    ],
    applications: [
      "High-volume production",
      "Large-scale manufacturing",
  ...
  "kdf-1": {
    tagline: "Hauni KDF-1, a filter line built on a strong reputation for precision and durability.",
    h1: "Hauni KDF-1 Cigarette Filter Manufacturing Machine",
    metaTitle: "Hauni KDF-1 Filter Making Machine",
    metaDescription: "Hauni KDF-1 filter making machine, 120mm filters with laser circumference control, exported from Pakistan to South Africa.",
    intro: [
      "With a strong reputation for performance, precision and durability, the Hauni KDF-1 is a proven filter line for the demands of high-volume production, suiting manufacturers who put consistency, speed and quality first.",
      "Built for high-output running, it handles 120mm filters comfortably, working well for both standard and customised cigarette formats. Filter circumference range spans 16.8mm to 28.1mm with lengths from 64mm to 150mm, covering King Size filters through to Slims and specialised designs without constant machine changes.",
      "An advanced PLC control system, available in Siemens or Beckhoff configurations, gives intuitive control, real-time diagnostics and reliable automation that holds filter quality steady through the run, with Lenze or Beckhoff servo systems adding stability and smooth, accurate motion.",
      "A standout feature is the laser-based circumference control system, measuring each filter's circumference with high precision to cut deviation and keep every batch uniform, a level of accuracy that matters for holding brand quality standards on premium products.",
      "For all its output, the KDF-1 keeps a balanced energy profile at a total of 40KW, efficient to run over the long term. Its sturdy build gives long service life, and its modular design fits both smaller and large-scale filter production, whether expanding capacity or upgrading older machinery.",
    ],
    applications: [
  ...
  "kdf-2": {
    tagline: "Hauni KDF-2, a world-class line running acetate tow at 400 metres a minute.",
    h1: "Hauni KDF-2 Cigarette Filter Manufacturing Machine",
    metaTitle: "Hauni KDF-2 High-Speed Filter Making Machine",
    metaDescription: "Hauni KDF-2 filter making machine, 400 metres per minute of acetate tow, exported from Pakistan to South Africa with Siemens/Beckhoff PLC.",
    intro: [
      "Known for engineering quality and advanced automation, the Hauni KDF-2 is a world-class filter line built for high-efficiency, high-output production, a trusted choice for large-scale manufacturers who need both precision and productivity.",
      "It processes acetate tow at an impressive 400 metres a minute, matched by real format versatility: filter circumferences of 16.8mm to 28.1mm and lengths of 64mm to 150mm, covering everything from standard King Size filters to more specialised formats with minimal downtime.",
      "Automation sets the KDF-2 apart. A PLC control system, in Siemens or Beckhoff configuration, gives full control and real-time monitoring, while a high-performance Lenze or Beckhoff servo system keeps movement accurate and operation dependable, reducing error and keeping filter quality uniform as a reliable backbone for continuous, large-scale manufacturing.",
      "Built for durability, the KDF-2 pairs with a tow opener and the HCF80 automatic tray filler to streamline the workflow and cut manual handling, drawing 40KW for the main unit and 15KW for the HCF80 filler.",
      "Even with that capability, the KDF-2 keeps a manageable footprint at around 6,500kg, its solid construction built for long-term durability under demanding schedules, a smart investment whether setting up a new facility or upgrading existing machinery.",
    ],
    applications: [
      "High-volume filter production",
      "Large-scale manufacturing",
  ...
  "molins-pm-5": {
    tagline: "Molins PM-5, a high-capacity filter maker built for large-scale production.",
    h1: "Molins PM-5 Filter Maker",
    metaTitle: "Molins PM-5 Cigarette Filter Making Machine",
    metaDescription: "Molins PM-5 filter making machine, 4,000 filters per minute, exported from Pakistan to South Africa by Civic Tobacco Machinery.",
    intro: [
      "Built for the demands of large-scale production, the Molins PM-5 turns out 4,000 filters a minute, a strong example of efficiency and precision in filter manufacturing for busy factories.",
      "Useful flexibility on sizing comes built in, with a filter rod diameter of 7.5 to 7.8mm and rod lengths from 108 to 126mm, so it accommodates different filter specifications without difficulty.",
      "At around 2,000kg the PM-5 carries a sturdy build for durability and stable running over long periods. Made by Molins, a well-known name in the industry, it combines proven engineering with high-speed output, an essential asset for manufacturers chasing quality filters while maximising throughput.",
    ],
    applications: [
      "High-volume filter production",
      "Molins-based lines",
  ...
  "hollow-tube-maker": {
    tagline: "Hollow Tube Maker, built for speed in speciality filter tube production.",
    h1: "Hollow Tube Maker",
    metaTitle: "Hollow Tube Maker, Cigarette Filter Machine",
    metaDescription: "Hollow tube maker, 2,100 cigarettes per minute with plug assembler, exported from Pakistan to South Africa for speciality filter formats.",
    intro: [
      "The Hollow Tube Maker stands out for capacity and pace, producing 2,100 cigarettes a minute with strong efficiency and consistent output. A rod speed range of 140 to 175 metres a minute, alongside a cut-off speed of up to 2,500 rods a minute, underlines how well it suits high-volume production.",
      "At 3,050kg the maker carries a robust build for durability and long-term reliability, with the plug assembler adding a further 1,800kg and working in step for precise, efficient tube production. Total power draw comes to 14kW, split between 6.5kW for the maker and 7.5kW for the plug assembler, balancing performance against energy use.",
      "Designed for large-scale manufacturing, the Hollow Tube Maker uses up-to-date technology to turn out high-quality tubes, a valuable asset for producers needing to meet strong demand while holding excellent production standards.",
    ],
    applications: [
      "High-volume filter production",
  ...
  "tobacco-feeder": {
    tagline: "Tobacco feeder keeping a steady, layered flow into Mark 8 and Mark 9 makers.",
    h1: "Tobacco Feeder",
    metaTitle: "Tobacco Feeder for Cigarette Making Machines",
    metaDescription: "Tobacco feeder for Mark 8 and Mark 9 cigarette makers, exported from Pakistan to South Africa by Civic Tobacco Machinery.",
    intro: [
      "As one of the crucial input machines on a cigarette factory floor, the tobacco feeder feeds tobacco continuously and evenly into the making machine, layering it neatly so it's prepared exactly right before production.",
      "Compatible with Mark 8 and Mark 9 machines, it slots into an existing setup with ease. Adjustable volume settings give precise control over tobacco flow, and its automation cuts manual handling, streamlining operation and holding productivity high.",
    ],
    applications: [
      "Maker feeding",
  ...
  "cigarette-reclaimer": {
    tagline: "Cigarette Reclaimer recovering waste tobacco at 120 kg/hour, 99.8% efficient.",
    h1: "Cigarette Reclaimer",
    metaTitle: "Cigarette Reclaimer, Tobacco Recovery Machine",
    metaDescription: "Cigarette reclaimer, recovers manufacturing waste tobacco at 120 kg/hour with 99.8% efficiency, exported from Pakistan to South Africa.",
    intro: [
      "The Cigarette Reclaimer is a genuinely effective tobacco recovery machine for manufacturing waste, separating reusable tobacco from waste material with very small losses, so tobacco that would otherwise be discarded goes back into production.",
      "At maximum capacity it reclaims 120 kg an hour at 99.8% efficiency, giving the highest possible utilisation, and with a 90% recovery rate it delivers a genuine advantage in cutting waste and lifting overall production efficiency.",
      "User-friendly and straightforward to install into an existing line, it's a practical, cost-saving addition for factories wanting to get the most out of every batch.",
    ],
    applications: [
      "Waste reduction",
      "Tobacco recovery",
  ...
  "tobacco-cutters": {
    tagline: "Hauni KT-400, a five-knife cutter with PLC-regulated cut size.",
    h1: "Hauni Tobacco Cutter KT-400",
    metaTitle: "Hauni Tobacco Cutter KT-400",
    metaDescription: "Hauni Tobacco Cutter KT-400, five-knife cutter with PLC-regulated cut size, exported from Pakistan to South Africa.",
    intro: [
      "The Hauni Tobacco Cutter KT-400 is a precision-engineered machine that plays a crucial role in holding cut quality consistent through tobacco processing. Its five knives deliver uniform cuts that improve the overall quality of the tobacco blend, while pneumatic cylinders operate the jaw for smooth, efficient cutting with less downtime and maintenance.",
      "An advanced PLC drive system on a brass bend slat regulates cut size precisely, keeping every batch uniform while letting you tailor cut size to specific requirements. That precision and reliability make the KT-400 an important asset for any tobacco production facility aiming for top quality and efficiency.",
    ],
    applications: [
      "Primary processing",
      "Cut rag preparation",
  ...
  "tobacco-stem-flattener": {
    tagline: "Tobacco Stem Flattener smoothing the way to uniform blending and less leaf waste.",
    h1: "Tobacco Stem Flattener",
    metaTitle: "Tobacco Stem Flattener, Primary Processing Machine",
    metaDescription: "Tobacco stem flattener, flattens stems for uniform blending and reduced leaf waste, exported from Pakistan to South Africa.",
    intro: [
      "The Tobacco Stem Flattener plays a key role in optimising the tobacco processing workflow, flattening stems so they blend uniformly with the leaf, which improves processing ease and reduces inconsistencies in the final product.",
      "By flattening stems efficiently, it also minimises leaf waste, making the whole process more economical and sustainable. The result is a consistent, high-quality product that meets strict industry standards, a valuable asset for any tobacco processing operation.",
    ],
    applications: [
      "Primary processing",
      "Yield improvement",
...
const zw: Record<string, ProductContent> = {
  "hlp-180": {
    tagline: "Single plunger hard pack line built for steady 180-pack-a-minute output.",
    h1: "HLP-180 Cigarette Packing Machine",
    metaTitle: "HLP-180 Cigarette Packing Machine, 180 Packs/Min",
    metaDescription: "HLP-180 cigarette packing machine exported to Zimbabwe, PLC-controlled hard pack line covering King to Nano formats at 180 packs per minute. Supplied by Civic Tobacco Machinery.",
    intro: [
      "Built for factories scaling up hard pack output without sacrificing finish quality, the HLP-180 is a next-generation single plunger packer that holds a steady rhythm pack after pack.",
      "At 180 packs a minute, the single plunger mechanism keeps alignment, wrapping and sealing consistent on every cycle, giving manufacturers exporting from Pakistan a dependable high-volume packer to build a line around.",
      "Format range is broad: King Size, Demi, Slims, Super Slims and Nano all run on the same machine, so one packer can serve established local brands and newer, niche formats without switching to a different unit.",
      "A PLC control system automates the process end to end, so packs come out uniform and retail-ready, while the interface gives operators a clear window into speed, faults and output, cutting downtime along the way.",
      "Pack shape flexibility, round corner, bevel edge, D-type and square, lets brands differentiate on the shelf, and the build is suited to continuous, large-scale running, whether it is the first packer on a new line or a replacement for older equipment.",
    ],
    applications: [
      "High-volume hard pack production",
      "Local and export markets",
  ...
  "hlp-200": {
    tagline: "Double plunger hopper packer built to carry the core of a 200-pack-a-minute line.",
    h1: "HLP-200 Cigarette Packing Machine",
    metaTitle: "HLP-200 Cigarette Packing Machine, 200 Packs/Min",
    metaDescription: "HLP-200 cigarette packing machine exported to Zimbabwe, double plunger hopper line running 200 packs per minute across King to Nano formats. Supplied by Civic Tobacco Machinery.",
    intro: [
      "The HLP-200 is a double plunger hopper packer sized for small-to-medium operations stepping up toward high-volume output, and it is economical on material, which keeps running costs down as the line speeds up.",
      "Sitting at the front of the packing line, it forms and finishes each pack before wrapping and boxing take over, running at 200 packs a minute with throughput up to roughly 12,000 cigarettes, and it accepts the common pack formats a factory is already set up for.",
      "The double plunger system keeps that pace efficient across King Size, Demi, Slims, Super Slims and Nano formats, while a PLC control system automates the cycle and gives operators a direct view of speed, faults and output.",
      "It presents packs in round corner, bevel edge, D-type or square styles, runs on either 220V or 380V supply, and is built as a dependable core unit for a continuous, integrated packing line.",
    ],
    applications: [
      "High-volume hard pack production",
      "Core of an integrated packing line",
  ...
  "hlp-225": {
    tagline: "Double plunger hard pack line built for 225-pack-a-minute throughput.",
    h1: "HLP-225 Cigarette Packing Machine",
    metaTitle: "HLP-225 Cigarette Packing Machine, 225 Packs/Min",
    metaDescription: "HLP-225 cigarette packing machine exported to Zimbabwe, high-speed 225 packs per minute double plunger line with PLC control. Supplied by Civic Tobacco Machinery.",
    intro: [
      "Where a factory needs to pack at real scale, the HLP-225 is the step up. Its double plunger mechanism holds 225 packs a minute without the finish suffering for the extra speed.",
      "It is built to run King Size, Demi, Slims, Super Slims and Nano on one machine, so manufacturers supplying Zimbabwe and neighbouring markets get format flexibility rather than a single-purpose line.",
      "A modern PLC control system handles the automation, trims manual intervention and keeps error rates low, while round corner, bevel edge, D-type and square pack options let brands tailor presentation to what their market expects.",
      "The build is rated for large-scale, continuous production, pairing that format range and automation with a frame solid enough to hold pace and quality as output scales up.",
    ],
    applications: [
      "High-volume hard pack production",
      "Large-scale packing lines",
  ...
  "sasib-5000": {
    tagline: "SASIB soft pack line for 100mm packs with a clean, squared finish.",
    h1: "SASIB 5000 Soft Pack Machine",
    metaTitle: "SASIB 5000 Soft Pack Cigarette Machine",
    metaDescription: "SASIB 5000 soft pack cigarette machine exported to Zimbabwe, 100mm soft packs finished with alufoil and label wrapping. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "Soft pack production for 100mm cigarettes is the SASIB 5000's job, and it does it with an arbour-based alufoil and label wrap that leaves every pack with the same neatly squared corners.",
      "That wrapping method is not just cosmetic. It holds the pack together and protects the cigarettes inside, which matters for manufacturers exporting a premium soft pack product to markets like Zimbabwe.",
      "It is a proven, straightforward machine to run day to day, and every unit we supply is checked and set up before it reaches the floor, so adding soft pack capacity does not mean adding risk.",
    ],
    applications: [
      "Soft pack production",
      "100mm formats",
  ...
  "sasib-3000": {
    tagline: "SASIB soft pack line covering both 84mm and 100mm formats.",
    h1: "SASIB 3000 Soft Pack Machine",
    metaTitle: "SASIB 3000 Soft Pack Cigarette Machine",
    metaDescription: "SASIB 3000 soft pack cigarette machine exported to Zimbabwe, handles both 84mm and 100mm packs with alufoil and label wrapping. Supplied by Civic Tobacco Machinery.",
    intro: [
      "The SASIB 3000 covers both 84mm and 100mm cigarette packs on one machine, wrapping each in alufoil and label around an arbour for the same squared-corner SASIB finish across either size.",
      "That dual-format ability is useful for manufacturers who need to run more than one pack size without adding a second machine, while every pack still meets the same presentation and protection standard.",
      "Adjustments and maintenance are handled through straightforward control systems that keep downtime low, and the machine ships checked and set up, ready to run soft pack production the day it lands.",
    ],
    applications: [
      "Soft pack production",
      "84mm and 100mm formats",
  ...
  "regular-wrapper-cp1": {
    tagline: "Cigarette pack overwrapper rated to 250 packs a minute.",
    h1: "Regular Wrapper CP1",
    metaTitle: "CP-1 Cigarette Pack Wrapping Machine, 250 PPM",
    metaDescription: "CP-1 cigarette pack wrapping machine exported to Zimbabwe, overwraps up to 250 packs per minute. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "The CP-1 is a high-performance overwrapper built to keep pace with a fast packing line, wrapping at up to 250 packs a minute without becoming the bottleneck further down the process.",
      "It runs on a modest 6 KVA and needs only 0.05 m³/min of air pressure, so the speed does not come with a heavy power bill, and the wrap itself stays precise and consistent, cutting material waste.",
      "Its build is robust enough for high-volume, continuous lines, and it fits into an existing setup without much rework, making it a practical addition wherever a factory needs to lift wrapping capacity.",
    ],
    applications: [
      "Pack overwrapping",
      "High-volume packing lines",
  ...
  "naked-over-wrapper": {
    tagline: "Outer pack overwrapper running 25 packs a minute.",
    h1: "Naked Over Wrapper",
    metaTitle: "Naked Over Wrapper, Cigarette Outer Pack Wrapper",
    metaDescription: "Naked Over Wrapper exported to Zimbabwe, wraps cigarette outer packs at 25 packs per minute. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "The Naked Over Wrapper handles the outer pack stage, wrapping 25 packs a minute with the precision needed to keep that part of the line from slowing everything behind it.",
      "Power draw is a modest 6 KVA with an air pressure requirement of 0.05 m³/min, which keeps it efficient to run, and its robust build makes it a solid, unfussy addition at the final packaging stage.",
    ],
    applications: [
      "Outer pack overwrapping",
      "End-of-line sealing",
  ...
  "molins-boxer": {
    tagline: "Box packing machine running up to 20 boxes a minute.",
    h1: "Molins Boxer, Box Packing Machine",
    metaTitle: "Molins Boxer, Cigarette Box Packing Machine",
    metaDescription: "Molins Boxer box packing machine exported to Zimbabwe, packs cigarette cartons at up to 20 boxes per minute. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "At the end of the line, the Molins Boxer takes wrapped packs and turns them into finished cartons, running at up to 20 boxes a minute with the kind of steady, dependable cycle factories build a shift around.",
      "Air pressure requirement sits at 0.05 m³/min, a modest draw for the throughput it delivers, and the build is engineered to hold that consistency and precision over long runs, which keeps downtime down.",
      "For an operation focused on steady, efficient cartoning, it is a solid, well-proven finishing unit for the end of a cigarette packing line.",
    ],
    applications: [
      "Carton / box packing",
      "End-of-line collation",
  ...
  "sasib-boxer": {
    tagline: "Box packing machine running up to 25 boxes a minute.",
    h1: "SASIB Boxer, Box Packing Machine",
    metaTitle: "SASIB Boxer, Cigarette Box Packing Machine",
    metaDescription: "SASIB Boxer box packing machine exported to Zimbabwe, packs cigarette cartons at up to 25 boxes per minute. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "The SASIB Boxer pushes cartoning speed further, packing up to 25 boxes a minute and giving a real lift to the throughput of the line it sits at the end of.",
      "It draws 6 KVA and needs 0.1 m³/min of air pressure, a balance of power and output that suits high-volume environments where speed cannot come at the cost of accuracy.",
      "Consistent, precise packing keeps downtime low, which is exactly what matters in an environment where both speed and product quality are being watched closely.",
    ],
    applications: [
      "Carton / box packing",
      "High-volume packing lines",
  ...
  "mark-8-post-64": {
    tagline: "Reliable Mark 8 rod maker that factories keep coming back to.",
    h1: "Mark 8 Post 64 – Cigarette Manufacturing Machine in Zimbabwe",
    metaTitle: "MK 8 | Mark 8 Post 64 Cigarette Manufacturing Machine",
    metaDescription: "Molins Mark 8 Post 64 cigarette making machine exported to Zimbabwe, a reliable rod maker for steady production. Reconditioned and supported by Civic Tobacco Machinery.",
    intro: [
      "The Mark 8 Post 64 has stayed on production floors for a reason: it holds a steady 1,800 to 2,000 cigarettes a minute, and its double colour printer lets you print paper to brand spec without slowing the line.",
      "Format range covers cigarette circumferences from 17mm to 28.3mm and combined filter-and-tobacco rod lengths from 65mm to 110mm, spanning standard 84mm and 100mm through to slims, super slims and nano, with a Max Multiroll filter attachment keeping filters feeding cleanly at full speed.",
      "At around 3,500kg it is a heavy, solidly built machine made to hold pace through long runs, which is what makes it a dependable single-maker choice for factories that do not want speed and reliability traded off against each other.",
    ],
    features: [
      "Proven, long-life Molins design",
      "Even rod and clean cut",
  ...
  "mark-8d-max-15": {
    tagline: "Mark 8D maker line paired with the MAX-15 control system.",
    h1: "Mark 8D MAX 15",
    metaTitle: "MK 8D | Molins Mark 8D with MAX-15 Cigarette Maker",
    metaDescription: "Molins Mark 8D with MAX-15 cigarette making machine exported to Zimbabwe, running up to 3,000 cigarettes per minute across King to Nano formats. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "Part of the well-established Mark 8 family, the Mark 8D with MAX-15 gives manufacturers a dependable way to add output without stepping down on quality, built for a modern tobacco factory's pace.",
      "Top speed sits at 3,000 cigarettes a minute, comfortable for a busy line, and it is not tied to one format: King size, Demi, Slims, Super Slims and Nano all run on the same maker, useful for a factory supplying more than one market segment.",
      "Cigarette circumference range runs 17mm to 28.3mm, with combined filter and tobacco rod lengths from 65mm to 110mm, giving full control over sizing and consistency run to run.",
      "The MK-8D maker pairs with the MAX-15 and its 1117 infeed unit, carrying tobacco through to a finished rod with fewer stoppages and steadier quality across a shift, all at a total draw of 17KW, sensible for the output it delivers.",
      "The footprint stays manageable too: at around 5,000kg it is solid without needing a major floor rebuild to install, and day to day it turns out even rods with low waste and modest upkeep.",
      "Reliability, format flexibility from slims to nano, accurate high-speed output and straightforward integration into an automated line are what make the Mark 8D with MAX-15 a sound pick whether you are replacing old equipment or adding fresh capacity.",
    ],
    applications: [
      "High-volume production",
      "Multi-format factories",
  ...
  "mark-9-5-lenze-servo-drives": {
    tagline: "Mark 9.5 line with Lenze servo drives for high-speed, high-precision output.",
    h1: "Molins Mark 9.5 with Lenze Servo Drives",
    metaDescription: "Molins Mark 9.5 with Lenze servo drives exported to Zimbabwe, up to 3,500 cigarettes per minute with Siemens PLC and microwave weight control. Supplied by Civic Tobacco Machinery.",
    intro: [
      "Manufacturers wanting serious output without narrowing their format range should look at the Mark 9.5 with Lenze servo drives: 3,500 cigarettes a minute on regular diameters, 3,200 on slim and super slim, all from one line.",
      "Circumference range spans 17mm to 28.3mm and combined filter and tobacco rod length runs 65mm to 110mm, room enough to switch formats and still hold a consistent rod from one run to the next.",
      "Three units make up the line, the MK-9.5 maker, the MAX-S filter assembler and the HCF80 automatic tray filler, drawing 35KW, 20KW and 15KW respectively, taking the process from raw make through to filled trays with little manual handling between stages.",
      "A Siemens PLC keeps the sequence running smoothly, a microwave system holds rod weight to tight tolerances, and the Lenze servo drives deliver the steady motion that keeps quality up even at full speed.",
      "At roughly 8,600kg total it is a heavy, stable line meant for large-scale manufacturing, a strong option for a factory that wants dependable high-volume output with modern controls and easy servicing.",
    ],
    applications: [
      "High-volume production",
      "Multi-format factories",
  ...
  "mark-9-5-max-s-tray-filler": {
    tagline: "Mark-9.5 line with Max S and a mass flow tray filler for large-scale output.",
    h1: "Molins Mark-9.5 with Max S & Tray Filler",
    metaTitle: "Molins Mark-9.5 with Max S & Tray Filler",
    metaDescription: "Molins Mark-9.5 with Max S and tray filler exported to Zimbabwe, running 4,500 to 5,000 cigarettes per minute. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "For manufacturers chasing genuine high-volume output, the Mark-9.5 with Max S and tray filler runs 4,500 to 5,000 cigarettes a minute, putting it among the faster lines available for a large-scale factory.",
      "The MK-9.5 maker at its core is a refinement of the well-proven Mark 9 series, holding strong output without giving up precision, and it covers cigarette circumferences from 17mm to 28.3mm and combined filter-and-tobacco rod lengths from 65mm to 110mm, so King size, Slims, Demi and other formats can share the same line.",
      "Filter attachment runs through the Max-S assembler and a mass flow tray filler, which keeps throughput high while holding material waste and misalignment down, so filter integrity stays consistent cycle after cycle.",
      "A default 84mm setup size keeps it aligned with globally standard cigarette dimensions, useful whether the output is headed for local sale or export production, and it moves between batches without much friction as orders change.",
      "At around 7,800kg it is a heavy, stable line designed for continuous operation, bringing together proven making, precise filter attachment and a durable frame for a factory that wants to scale up while keeping downtime low.",
    ],
    applications: [
      "High-volume production",
      "Export-ready manufacturing",
  ...
  "mark-9-max-s": {
    tagline: "MK-9 maker with Max S for high-speed, mass flow filter attachment.",
    h1: "Molins MK-9 with Max S",
    metaTitle: "Molins MK-9 with Max S",
    metaDescription: "Molins MK-9 with Max S exported to Zimbabwe, running 4,500 to 5,000 cigarettes per minute with a mass flow tray filler. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "The MK-9 with Max S is another high-efficiency maker aimed squarely at serious production, running between 4,500 and 5,000 cigarettes a minute for factories that want strong, steady output from a single line.",
      "At its core, the MK-9 maker holds production precise and consistent shift after shift, working across cigarette circumferences from 17mm to 28.3mm and combined filter and tobacco rod lengths from 65mm to 110mm, giving real flexibility to move between formats without losing rod quality.",
      "The Max-S filter assembler and a mass flow tray filler make filter attachment faster and more reliable while keeping waste and misalignment low, and a default 84mm setup size keeps it in line with widely accepted cigarette dimensions.",
      "At around 7,800kg the MK-9 is heavy and stable, built for continuous running and a long service life, a solid choice for a factory scaling up large-scale production without wanting to compromise on quality.",
    ],
    applications: [
      "High-volume production",
      "Main maker line",
  ...
  "protos-70": {
    tagline: "Hauni Protos 70 line running up to 7,000 cigarettes a minute.",
    h1: "Protos 70",
    metaTitle: "Hauni Protos 70 Cigarette Making Machine",
    metaDescription: "Hauni Protos 70 cigarette making machine exported to Zimbabwe, up to 7,000 per minute with Siemens or Beckhoff IPC control. Supplied by Civic Tobacco Machinery.",
    intro: [
      "The Hauni Protos 70 is engineered toward the higher end of production efficiency, running 7,000 cigarettes a minute on regular diameters and 6,000 on slim and super slim formats, giving factories real speed and format flexibility from one line.",
      "Cigarette circumference range runs 17mm to 28.3mm with combined filter and tobacco rod lengths from 65mm to 110mm, so formats can change without the rod losing consistency from run to run.",
      "A Siemens or Beckhoff IPC control system keeps the sequence automated and reliable, and a microwave weight control system holds every cigarette to a precise weight; the line itself is made up of the S7000 rod maker, the M8000 filter tip attachment and the F80 automatic tray filler, each handling its stage cleanly.",
      "Power draw runs 50KW for the S7000, 20KW for the M8000 and 15KW for the F80, and at a total weight of around 10,800kg the Protos 70 is heavy, stable and built for the kind of continuous running large-scale cigarette production demands.",
    ],
    applications: [
      "High-volume production",
      "Large-scale manufacturing",
  ...
  "protos-80-er": {
    tagline: "Hauni Protos 80 ER line built for 8,000 cigarettes a minute.",
    h1: "Protos 80 ER",
    metaTitle: "Hauni Protos 80 ER Cigarette Making Machine",
    metaDescription: "Hauni Protos 80 ER cigarette making machine exported to Zimbabwe, up to 8,000 per minute with Siemens or Beckhoff IPC control. Supplied by Civic Tobacco Machinery.",
    intro: [
      "Hauni built the Protos 80 series around maximum efficiency, precision and output, and whether the run is regular or slim cigarettes, it holds consistency and productivity that has made it a trusted choice on high-volume lines.",
      "Capacity tops out at 8,000 cigarettes a minute on regular diameters and 7,000 on slim and super slim formats, with cigarette circumferences from 17mm to 28.3mm and combined filter and tobacco rod lengths from 65mm to 110mm, covering king size through to slim and niche formats on the same machine.",
      "A high-level PLC control system, run on either a Siemens IPC or a Beckhoff IPC, keeps the cycle smooth and automated, with real-time monitoring cutting human error and a built-in microwave weight control system holding consistent cigarette weight across the run.",
      "Three units work in sequence, the S7000 rod maker at 50KW, the M8000 filter tip attachment at 20KW and the F80 automatic tray filler at 15KW, and at a total weight of around 10,800kg the whole line is heavy, stable and used in cigarette factories worldwide for continuous, large-scale production with low wastage and precise engineering.",
    ],
    applications: [
      "High-volume production",
      "Large-scale manufacturing",
  ...
  "kdf-1": {
    tagline: "Hauni KDF-1 filter line with laser circumference control.",
    h1: "Hauni KDF-1 Cigarette Filter Manufacturing Machine",
    metaTitle: "Hauni KDF-1 Filter Making Machine",
    metaDescription: "Hauni KDF-1 filter making machine exported to Zimbabwe, 120mm filters with Siemens/Beckhoff PLC and laser circumference control. Supplied by Civic Tobacco Machinery.",
    intro: [
      "The KDF-1 has built its reputation on performance, precision and durability, and it suits manufacturers who put consistency and speed first in high-volume filter production.",
      "Production capacity centres on 120mm filters, useful for both standard and customised cigarette formats, and it covers filter circumferences from 16.8mm to 28.1mm and filter lengths from 64mm to 150mm, so King Size filters, Slims and more specialised designs can all run without constant machine changeovers.",
      "Control runs through an advanced PLC system in either Siemens or Beckhoff configuration, giving intuitive operation, real-time diagnostics and reliable automation, with Lenze or Beckhoff servo systems adding smooth, accurate motion.",
      "A laser-based circumference control system measures each filter with high precision, cutting deviation and keeping every batch uniform, which matters when a brand's quality standard depends on consistency at this stage.",
      "Total power draw is a balanced 40KW, and the KDF-1's sturdy build gives it long service life; its modular design and compatibility with different cigarette types make it a fit for both smaller operations and large-scale filter production, whether expanding capacity or replacing older machinery.",
    ],
    applications: [
      "High-volume filter production",
      "Standard and specialised filters",
  ...
  "kdf-2": {
    tagline: "High-speed Hauni KDF-2 filter line at 400 metres a minute.",
    h1: "Hauni KDF-2 Cigarette Filter Manufacturing Machine",
    metaTitle: "Hauni KDF-2 High-Speed Filter Making Machine",
    metaDescription: "Hauni KDF-2 filter making machine exported to Zimbabwe, 400 metres per minute of acetate tow with Siemens/Beckhoff PLC. Supplied by Civic Tobacco Machinery.",
    intro: [
      "The KDF-2 is built for factories that need both precision and real throughput in filter production, and its engineering quality has made it a trusted choice among large-scale manufacturers.",
      "It processes acetate tow at 400 metres a minute, a pace matched by genuine versatility: filter circumferences from 16.8mm to 28.1mm and filter lengths from 64mm to 150mm cover everything from standard King Size filters to more specialised formats, with minimal downtime between them.",
      "Automation is where the KDF-2 stands apart. A PLC control system in Siemens or Beckhoff configuration gives full control and real-time monitoring, while a high-performance Lenze or Beckhoff servo system keeps movement accurate, holding filter quality uniform across long runs.",
      "It pairs with a tow opener and the HCF80 automatic tray filler to cut manual handling, drawing 40KW for the main unit and 15KW for the HCF80, a workable balance of energy use and output.",
      "Despite the capability on offer, the KDF-2 keeps a manageable footprint at around 6,500kg, with a solid build for long-term durability, whether it is going into a new facility or replacing older machinery.",
    ],
    applications: [
      "High-volume filter production",
      "Large-scale manufacturing",
  ...
  "molins-pm-5": {
    tagline: "Molins PM-5 filter maker at 4,000 filters a minute.",
    h1: "Molins PM-5 Filter Maker",
    metaTitle: "Molins PM-5 Cigarette Filter Making Machine",
    metaDescription: "Molins PM-5 filter making machine exported to Zimbabwe, high-capacity maker at 4,000 filters per minute. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "The Molins PM-5 is built for the demands of large-scale filter production, turning out 4,000 filters a minute with the precision that name is known for.",
      "Sizing flexibility is built in too, with a filter rod diameter of 7.5 to 7.8mm and filter rod lengths from 108 to 126mm, so it accommodates a range of filter specifications without difficulty.",
      "At around 2,000kg it is a sturdy, stable machine for long periods of running, combining Molins' proven engineering with the kind of high-speed output that keeps throughput and filter quality both where they need to be.",
    ],
    applications: [
      "High-volume filter production",
      "Molins-based lines",
  ...
  "hollow-tube-maker": {
    tagline: "Hollow tube maker running 2,100 cigarettes a minute.",
    h1: "Hollow Tube Maker",
    metaTitle: "Hollow Tube Maker, Cigarette Filter Machine",
    metaDescription: "Hollow tube maker exported to Zimbabwe, 2,100 per minute with a plug assembler for speciality filter tubes. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "The Hollow Tube Maker is built for speciality tube production at real volume, turning out 2,100 cigarettes a minute with a rod speed range of 140 to 175 metres a minute and a cut-off speed of up to 2,500 rods a minute.",
      "The maker itself weighs around 3,050kg, with the plug assembler adding another 1,800kg and working in step with it for precise tube production. Combined power draw is 14kW, split 6.5kW for the maker and 7.5kW for the plug assembler.",
      "It is built for large-scale manufacturing, and its speed and solid engineering make it a dependable choice for producers who need to meet strong demand without dropping production standards on speciality formats.",
    ],
    applications: [
      "High-volume filter production",
      "Speciality filter tubes",
  ...
  "tobacco-feeder": {
    ...
    h1: "Tobacco Feeder",
    metaTitle: "Tobacco Feeder for Cigarette Making Machines",
    metaDescription: "Tobacco feeder exported to Zimbabwe, delivers a steady, even tobacco flow to Mark 8 and Mark 9 cigarette makers. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "Every cigarette maker depends on what is feeding it, and the tobacco feeder's job is to keep that supply continuous and even, layering tobacco exactly right before it reaches production.",
      "It is built to slot straight into a Mark 8 or Mark 9 setup, and its adjustable volume settings give precise control over flow, while automation cuts manual handling and keeps the line running smoothly.",
    ],
    applications: [
      "Maker feeding",
      "Steady rod production",
  ...
  "cigarette-reclaimer": {
    ...
    h1: "Cigarette Reclaimer",
    metaTitle: "Cigarette Reclaimer, Tobacco Recovery Machine",
    metaDescription: "Cigarette reclaimer exported to Zimbabwe, recovers tobacco from manufacturing waste at 120 kg/hour with 99.8% efficiency. Supplied by Civic Tobacco Machinery.",
    intro: [
      "Manufacturing waste does not have to be a dead loss. The Cigarette Reclaimer separates reusable tobacco from waste material, sending what would otherwise be discarded back into production.",
      "At full capacity it reclaims 120 kg an hour at 99.8% efficiency, with a 90% recovery rate, a meaningful reduction in waste and a real lift to overall production efficiency.",
      "It is straightforward to install into an existing line and easy for operators to run day to day, which makes it a practical, cost-saving addition for any factory looking to get more out of every batch.",
    ],
    applications: [
      "Waste reduction",
      "Tobacco recovery",
  ...
  "tobacco-cutters": {
    ...
    h1: "Hauni Tobacco Cutter KT-400",
    metaTitle: "Hauni Tobacco Cutter KT-400",
    metaDescription: "Hauni Tobacco Cutter KT-400 exported to Zimbabwe, a five-knife cutter with PLC-regulated cut size. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "Cut quality sets the tone for everything downstream, and the Hauni KT-400 is built to keep it consistent. Five knives deliver uniform cuts across the blend, while pneumatic cylinders operate the jaw for smooth, efficient cutting with less downtime and maintenance.",
      "An advanced PLC drive system on a brass bend slat regulates cut size precisely, keeping every batch uniform while still letting you tailor the cut to specific requirements, which is what makes the KT-400 a dependable fixture in a primary processing floor aiming for both quality and efficiency.",
    ],
    applications: [
      "Primary processing",
      "Cut rag preparation",
  ...
  "tobacco-stem-flattener": {
    ...
    h1: "Tobacco Stem Flattener",
    metaTitle: "Tobacco Stem Flattener, Primary Processing Machine",
    metaDescription: "Tobacco stem flattener exported to Zimbabwe, flattens stems for uniform blending and reduced leaf waste. Supplied and serviced by Civic Tobacco Machinery.",
    intro: [
      "Stems that go into blending unevenly cause problems further down the line, and the Tobacco Stem Flattener exists to prevent that, flattening stems so they blend uniformly with the leaf and cutting the chance of inconsistency in the finished product.",
      "It also reduces leaf waste in the process, making the whole operation more economical, and the result is a consistent, high-quality product that holds up against strict industry standards, a genuinely useful addition to any tobacco processing line.",
    ],
    applications: [
      "Primary processing",
      "Yield improvement",
