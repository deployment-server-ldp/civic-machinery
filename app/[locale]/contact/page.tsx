    ...
    <>
      <PageHero
        ...
        crumbs={[
          ...
          { name: c.hero.eyebrow, path: localeHref(locale, "/contact") },
        ]}
      />
      ...
      <section className="container mx-auto py-14">
        <div className="grid gap-10 lg:grid-cols-2">
          {/* Details */}
          <div>
            <h2 className="text-2xl">{c.directHeading}</h2>
            <p className="mt-3 text-brand-600">{c.directText}</p>

            <div className="mt-8 space-y-5">
              <ContactRow label={c.rows.visit} icon="pin">
              ...
              <ContactRow label={c.rows.call} icon="phone">
                <a
              ...
              <ContactRow label={c.rows.whatsapp} icon="chat">
                <a
                  href={whatsappLink()}
                  target="_blank"
                  ...
                  className="text-brand-700 hover:text-accent-700"
                >
                  {c.rows.whatsappValue} {siteConfig.phoneDisplay}
                </a>
              </ContactRow>

              <ContactRow label={c.rows.email} icon="mail">
                <a
              ...
              <ContactRow label={c.rows.hours} icon="clock">
                <p className="text-brand-700">
                  {c.rows.hoursValue}
                  <br />
                  <span className="text-brand-500">{c.rows.hoursClosed}</span>
                </p>
              </ContactRow>
            </div>
          ...
          <div>
            <div className="rounded-2xl border border-brand-100 bg-white p-6 shadow-card sm:p-8">
              <h2 className="text-2xl">{c.formHeading}</h2>
              <p className="mt-2 text-sm text-brand-600">{c.formIntro}</p>
              <div className="mt-6">
